...
class OwedToMeScreen extends ConsumerWidget {
  const OwedToMeScreen({required this.onAdd, super.key});
      ...
      data: (entries) {
        if (entries.isEmpty) {
          return EmptyState(
            ...
            title: 'Nothing owed to you yet',
            message: 'Add a debt here when someone owes you money.',
            action: FilledButton.icon(
              onPressed: onAdd,
              icon: const Icon(Icons.add_rounded),
              label: const Text('Add Owed To Me'),
            ),
          );
        }
